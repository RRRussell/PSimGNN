...
# dataset = '{}/mcs_aids700nef_mccreesh2017_2018-11-27T02-36-27.553945_chris-desktop_all_4cpus_init'.format(dir_path)
# dataset = '{}/mcs_linux_mccreesh2017_2018-11-01T21_39_18.541863_chris-desktop_all_4cpus_init'.format(dir_path)
# dataset = '{}/mcs_imdbmulti_mccreesh2017_2018-12-06T16-23-18.547598_scai1_all_20cpus_init'.format(dir_path)

# dataset = '{}/mcs_aids700nef_mccreesh2017_test_train_init'.format(dir_path)
# dataset = '{}/mcs_linux_mccreesh2017_test_train_init'.format(dir_path)
#dataset = '{}/mcs_imdbmulti_mccreesh2017_test_train_init'.format(dir_path)
